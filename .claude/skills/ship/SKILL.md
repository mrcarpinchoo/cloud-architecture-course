...
4. **MEMORY.md** — Update project memory at
   `$HOME/.claude/projects/-Users-gamaware-Documents-Repos-personal-cloud-architecture-course/memory/MEMORY.md`
...
gh api graphql -f query='{
  repository(owner: "gamaware", name: "cloud-architecture-course") {
